...
import RepoList from '@/customComponents/RepoList';
  ...
  return (
    <div className='flex w-full min-h-screen flex-col items-center justify-center p-5 md:p-32'>
      <HyperText
        ...
        text="Search Repo"
      />
      <div className='w-full flex justify-center items-center mb-12 mt-12 space-x-4'>
        <Input type="text" placeholder="Search for public repo" className=' text-center  md:w-[30%] font-semibold' />
        <Button>
          Search
        </Button>
      </div>
      <div
        className="relative flex w-full max-w-[500px] items-center justify-center overflow-hidden rounded-lg bg-background pt-5 p-10 md:shadow-xl flex-col"
        ref={containerRef}
      >
